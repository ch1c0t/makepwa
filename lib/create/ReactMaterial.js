...
(function() {
  var createDeps, createIcons, createManifest, createPackageFile, createPages, createScripts, createSrc, createStyles, exec, fs;
  ...
  createSrc = function({name, dir}) {
    ...
    createDeps(src);
    return assets = ['/', '/index.html', '/manifest.webmanifest', '/styles/main.css', '/scripts/deps.js', '/scripts/deps.js.LICENSE.txt', '/scripts/main.js', '/icons/icon.192x192.png'];
  };
