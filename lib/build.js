...
(function() {
  var YAML, basename, build, buildDependencies, buildManifest, buildPages, buildScripts, buildStyles, buildWorkers, copyFile, ensureDirExists, failIfDirNotExists, glob, pug, readFileSync, sass, writeFileSync;
  ...
  module.exports = {build, buildPages, buildStyles, buildDependencies, buildScripts, buildWorkers, buildManifest};
