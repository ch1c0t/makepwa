...
(function() {
  var YAML, buildDependencies, buildScripts, buildWorkers, coffee, ensureDirExists, existsSync, handleWebpackErrors, readFileSync, runWebpack, webpack, writeFileSync;
  ...
  buildDependencies = function() {
    ...
    if (existsSync(file)) {
      ...
      return runWebpack({
        entry,
        output: `${targetDir}/dependencies.js`
      });
    }
  };
