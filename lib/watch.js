...
(function() {
  var BS, build, buildDeps, buildMainScript, buildManifest, buildPages, buildSWRegistration, buildStyles, buildWorkers, chokidar, watching;

  chokidar = require('chokidar');

  BS = require('browser-sync');

  ({build, buildPages, buildStyles, buildDeps, buildMainScript, buildSWRegistration, buildWorkers, buildManifest} = require('./build'));
